...
sim.add(m=(0.672**3.7)/332946,P=5.24969846,theta=3.3755376844593314, inc=89.6133*pi/180)
#1151.02 // Period is in days, convert to years (Divide by 365.2425)
sim.add(m=(0.948**3.7)/332946,P=7.41088006,theta=6.1176240098545245, inc=89.6418*pi/180)
...
sim.add(m=(1.229**3.7)/332946, P=10.43545334,theta=1.5428143395216987, inc=89.7017*pi/180)
#1151.04
sim.add(m=(0.759**3.7)/332946,P=17.45319318,theta=0.7952049261151819, inc=89.7854*pi/180)
#1151.05
sim.add(m=(0.801**3.7)/332946,P=21.72027051,theta=4.9711773818589755,inc=89.8007*pi/180)
